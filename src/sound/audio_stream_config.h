...
struct AudioStreamConfig {
  // BlockSize: Number of Frames processed each time AudioStream::process() is
  // called
  static constexpr int BlockSize = 32;

  // Oddly, the codec on the MP1 Disco board does not seem to work with
  // two's-complement data, despite the datasheet saying it does. So we use
  // unsigned data. TODO: Figure out why
