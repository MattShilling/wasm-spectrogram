//
// Emscripten/SDL2/OpenGLES2 sample that demonstrates simple geometry and
// shaders, mouse and touch input, and window resizing
//
// Setup:
//     Install emscripten:
...
//     FULL_ES2=1 -s WASM=0 -o hello_triangle.html
//
// Run:
//     emrun hello_triangle.html
//
// Result:
//     A colorful triangle.  Left mouse pans, mouse wheel zooms in/out.  Window
//     is resizable.
//
...
const GLchar *vertexSource = "uniform vec2 pan;                             \n"
                             "uniform float zoom;                           \n"
...
void mainLoop(void *mainLoopArg) {
  EventHandler &eventHandler = *reinterpret_cast<EventHandler *>(mainLoopArg);
...
int main(int argc, char **argv) {
  Camera camera;
  Window window("Hello Triangle", camera.windowSize().width,
